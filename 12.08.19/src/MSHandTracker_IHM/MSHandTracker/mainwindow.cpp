    ...
    ui(new Ui::MainWindow)
{
    ...
    mImageDisplay = new ImageDisplay(NULL, QCoreApplication::applicationDirPath()+"/ms.jpg");
...
void MainWindow::searchForDevice()
{
    ...
    connect(mDeviceSearcher, SIGNAL(trackingStarted()), mTrackingEnabled, SLOT(changeStatus()));
    connect(mDeviceSearcher, SIGNAL(trackingStopped()), mTrackingEnabled, SLOT(changeStatus()));
